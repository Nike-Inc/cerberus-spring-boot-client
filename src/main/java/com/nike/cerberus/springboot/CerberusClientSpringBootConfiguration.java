 ...
 *
 * <p>This class is configured via {@link CerberusClientSpringBootProperties} which has two required
 * settings for accessing Cerberus, e.g. in your {@code application.properties}:
 *
 * <pre>
...
public class CerberusClientSpringBootConfiguration {
    ...
    public CerberusClientSpringBootConfiguration(
            CerberusClientSpringBootProperties cerberusClientProperties) {
    ...
    public CerberusClient cerberusClient() {
        ...
        if (url == null || url.isEmpty()) {
            ...
            throw new IllegalArgumentException(
                    "cerberus.region setting is required! "
